    ...
    <div className="relative min-h-screen bg-ink text-parchment selection:bg-parchment selection:text-ink overflow-x-hidden">
        ...
        {!zenArtwork && (
          <>
            ...
            <div className="fixed -bottom-20 -left-20 text-[240px] font-extrabold opacity-[0.02] pointer-events-none select-none z-0 font-serif">
              MUSEUM
            </div>
        ...
        <AnimatePresence>
          {isNavOpen && (
            <motion.div
              ...
              className="fixed inset-0 z-50 bg-ink text-parchment flex flex-col justify-center px-8 md:px-24"
            >
              <button
              ...
              <nav className="space-y-8 md:space-y-12">
                {navigationItems.map((item, index) => (
                  <motion.button
                    ...
                    className={`text-5xl md:text-8xl font-serif text-left block w-full transition-all duration-500 hover:pl-8 group relative ${
                      currentPage === item.id ? 'opacity-100 italic' : 'opacity-40 hover:opacity-100'
                    }`}
                  >
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-24">
              <div>
                <h2 className="text-4xl md:text-6xl mb-8 leading-tight">
                  Every line is a <span className="italic">witness</span> to the moment.
                </h2>
                <p className="opacity-60 max-w-md text-lg leading-relaxed">
                  Starting from zero near the ghats of Varanasi. Building a bridge between traditional mastery and spiritual presence.
                </p>
              </div>
              <div className="flex flex-col justify-between items-start md:items-end uppercase tracking-widest text-xs space-y-12">
                <div className="flex space-x-12">
                  ...
                  <div className="space-y-4">
                    ...
                    <a href="mailto:akashdeepnarayan@gmail.com" className="hover:text-accent transition-colors underline decoration-white/20 underline-offset-4">akashdeepnarayan@gmail.com</a>
                  </div>
                </div>
